<template>
  <div class="home-container">
    <div class="header-container">
      <div>
        <img class="header-logo-img" src="~@/assets/images/img.png" @click="$router.push({ path: '/' })" />
      </div>
      ...
      <div class="view-container">
        ...
        <el-footer>
          <div class="about-container">
            <span class="desc-text"><a href="#" target="view_window">北京科技大学</a></span>
          </div>
        </el-footer>
      </div>
    </div>
...
export default {
  ...
  methods: {
    menuClickHandle(menu) {
        console.log(this.defaultActiveMenu === menu.route)
